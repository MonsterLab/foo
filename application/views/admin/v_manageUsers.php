...
<div>
    ...
    <?php 
        ...
        $html = "<table>";
        $html .= "<tr><th width='200'>征信编码</th><th width='200'>联系人姓名</th><th width='200'>客户类型</th><th width='200'>创建时间</th><th width='200'>操作</th></tr>";
        foreach ($userBases as $userBase){
            ...
            $html .= "<td align='center'><a href='{$base_url}admin/showUpdateView/{$userBase['id']}/'><input type='button' value='修改'></a>";
