<html>
    ...
    <body id="createGroup-body">
        <div id="createGroup">
            <h2>添加一个新的文章分组</h2>
            <div id="content">
                <form action="<?php echo base_url('admin/updateSGroup?space_gid='.$space_gid); ?>" method="post">
                    <?php 
                        if(isset($flag)){
                            echo '<p>'.$message.'</p>';
                        }
                    ...
                    <p>
                        ...
                        <input type="text" name="space_group_name" id="group_name" value="<?php echo $group_name;?>"/>
                    </p>
                    <p>
                        <label for="group_url">分类名称首字母缩写</label>
                        <input type="text" name="space_group_url" id="group_url" value="<?php echo $group_url;?>"/>
                    </p>
                    <p>
                        <label for="group_summary">分类描述信息</label>
                        <textarea name="space_group_summary" id="group_summary" cols="50" rows="5"><?php echo $group_summary;?></textarea>                            
                    </p>
                    <p>
